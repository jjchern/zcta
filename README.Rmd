...
- "2010 ZCTA to County Relationship File" (`zcta_county_rel_10.rda`)

- "2010 ZCTA to Tract Relationship File" (`zcta_tract_rel_10.rda`)
...
- [Data Source](https://www.census.gov/geographies/reference-files/time-series/geo/relationship-files.2010.html#par_textimage_674173622)
